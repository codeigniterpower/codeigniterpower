 ...
 * an associative array. WARNING: large files will crash based on php memory limit!
 * 
 * This library treats the first row of a CSV file
 * as a column header row. This library its not for large files. A large files lib are in development
 * 
 *
 * @package         CodeIgniter
 * @subpackage      Libraries
 * @category        Libraries
 * @author          Brad Stinson, redone by PICCORO lenz McKAY
 */
